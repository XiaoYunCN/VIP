...
local Windown = library.Create({ 
        Title = "Domadic Hub| [New]", Logo = 12523036534, 
                    ...
                    elseif workspace.Enemies:FindFirstChild("PirateBrigade") or workspace.Enemies:FindFirstChild("PirateGrandBrigade") or workspace.Enemies:FindFirstChild("FishBoat") and _G.RelzFishBoat then 
                        for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do 
                            if workspace.Enemies:FindFirstChild("PirateBrigade") or workspace.Enemies:FindFirstChild("PirateGrandBrigade") or workspace.Enemies:FindFirstChild("FishBoat") then 
                                ...
                                until not v.Parent or v.Health.Value < 0 or not workspace.Enemies:FindFirstChild("PirateBrigade") or not workspace.Enemies:FindFirstChild("PirateGrandBrigade") or not game:GetService("Workspace").Enemies:FindFirstChild("FishBoat") or not v:FindFirstChild("VehicleSeat") or not _G.RelzFishBoat 
                                Skillaimbot = false 
                                _G.SeaSkill = false 
                            end 
                        end 
    ...
    task.spawn(function() 
        while task.wait() do 
            pcall(function() 
                if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then 
                    FM:Set("๐ŸŒ• Full Moon 100%") 
                elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" then 
                    FM:Set("๐ŸŒ– Full Moon 75%") 
                elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709143733" then 
                    FM:Set("๐ŸŒ— Full Moon 50%") 
                elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709150401" then 
                    FM:Set("๐ŸŒ˜ Full Moon 25%") 
                elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149680" then 
                    FM:Set("๐ŸŒ˜ Full Moon 15%") 
                else 
        ...
        spawn(function() 
            pcall(function() 
                while wait() do 
        if game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage Island') then 
        MirageStatus:Set('๐Ÿ��๏ธ� Mirage Island is Spawning') 
        else 
        MirageStatus:Set('๐Ÿ��๏ธ� Mirage Island Not Spawn')  
        end 
        ...
        for i,v in pairs(game.Workspace:GetChildren()) do 
        if string.find(v.Name, "Fruit") then 
        FindFruit:Set('๐Ÿ�� Find '..v.Name) 
        else 
        FindFruit:Set('๐Ÿ�� Nothing')  
        end 
        end 
                end 
            end) 
            ...
            while wait(5) do 
                pcall(function() 
                        if GetLegendarySwordDealer() then 
                            SwordDealer:Set('โš”๏ธ� Legendary Sword Dealer is Spawning') 
                        else 
                            SwordDealer:Set('โš”๏ธ� Legendary Sword Dealer Not Spawn')  
                        end 

                        if game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer("ColorsDealer", "1") then 
                            HakiDealer:Set('๐ŸŸข Haki Dealer is Spawning') 
                        else 
                            HakiDealer:Set('๐Ÿ”ด Haki Dealer Not Spawn')  
                        end 
                end) 
            end 
        end) 
